...
export const useLogin = (): UseMutationResult<IAuthResponse, TAxiosRequestError, ILoginArgs> => {
  ...
  return useMutation(
    async (payload: ILoginArgs) => {
      const { data: userProfileResponse } = await instance.post(AUTH.LOGIN, payload);
